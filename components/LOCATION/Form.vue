  ...
  <Form v-slot="$form" :initialValues :resolver @submit="onFormSubmit" class="flex flex-col gap-4 w-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
      ...
      <div class="flex flex-col gap-1" key="population">
        ...
        <InputText name="population" type="text" :placeholder="$t('locations.form.population.placeholder')" :value="location.population" :disabled="loading" />
      ...
      <div class="flex flex-col gap-1" key="government">
        ...
        <InputText name="government" type="text" :placeholder="$t('locations.form.government.placeholder')" :value="location.government" :disabled="loading" />
